...
%\renewcommand{\theFancyVerbLine}{%  % Для увеличения размера цифр
%    \scriptsize\arabic{FancyVerbLine}%  % \large, \Large, \huge и т.д.
%}

%\setminted{
%    frame=single, % стиль рамки (lines, leftline, topline, bottomline, single)
%    framesep=8pt, % отступ кода от рамки
%    rulecolor=\color{black!80}, % цвет рамки
%    fontsize=\small,
%    linenos=true,          % Нумерация строк
%    breaklines=true,       % Перенос длинных строк
    % frame=lines,           % Рамка
    % bgcolor=LightGraye      % Фон (требуется xcolor)
%}
...
% \DeclareCaptionLabelFormat{mintedformat}{Листинг #2}
% \captionsetup[lstlisting]{
%     labelformat=mintedformat,
